...
export const engagementRingsFields: FieldDef[] = [
  ...
  { aspect: "Type", input: FieldInput.Text },
  { aspect: "Ring Size", input: FieldInput.Text, required: true },
  { aspect: "Band Width", input: FieldInput.Text },
  {
    aspect: "Setting Style",
    input: FieldInput.Enum,
